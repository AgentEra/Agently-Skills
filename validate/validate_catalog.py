...
OWNING_CONTRACTS: dict[str, tuple[Path, tuple[str, ...]]] = {
    "release_4148_audio": (
        SKILLS / "agently-request" / "references" / "audio.md",
        ("AudioModelRequest", "stream_tts", "stream_stt", "with_auto_break", "PCMFormat"),
    ),
    "release_4148_execution": (
        SKILLS / "agently-runtime" / "references" / "agent-execution.md",
        ("rework", "required_agent_capabilities", "long_content", "validate", "review", "artifact"),
    ),
    "release_4148_delivery": (
        SKILLS / "agently-request" / "references" / "output-control.md",
        ("auto_continue", "LongContent", "RootModel[str]", "base_revision", "Zero-Update"),
    ),
    "release_4148_shell": (
        SKILLS / "agently-runtime" / "references" / "actions-execution-resource.md",
        ("General Shell", "PowerShell", "offline", "online", "host", "risk_handler"),
    ),
